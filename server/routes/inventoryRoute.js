...
router.post("/add", authMiddleware, async (req, res) => {
  try {
    // check if the user is hospital or donor i.e., validate email and inventoryType
    ...
    if (req.body.inventoryType === "out") {
      ...
      // this will return the total "in" bloodgroup to the organization and this is a mongodb aggregate function
      ...
      // this will return the total "out" bloodgroup from the organization and this is a mongodb aggregate function
      ...
      if (availableQuantityOfRequestedGroup < requestedQuantity) {
        throw new Error(
          `Only ${availableQuantityOfRequestedGroup} units of ${requestedGroup.toUpperCase()} blood group is available!`
        );
      }
